...
export default function MainModal({ visible,onPress,visibility }) {
  return (
    ...
    <Modal visible={visible} animationType="slide">
      ...
      >
        ...
        <View style={{flexDirection:"row",marginTop:12,justifyContent:"space-evenly"}}>
            <TouchableOpacity style={styles.button} onPress={onPress}><Text style={{color:"white"}}>Accept</Text></TouchableOpacity>
            <TouchableOpacity style={styles.button} onPress={visibility}><Text style={{color:"white"}}>Decline</Text></TouchableOpacity>
        </View>
        <View style={{backgroundColor:"#ededed",flexDirection:"row",justifyContent:"center",alignItems:"center",height:40,marginTop:35}}> 
            <Text style={{fontSize:16}}>The driver is not willing to get paid for the ride.</Text>
        </View>
      </View>
    </Modal>
